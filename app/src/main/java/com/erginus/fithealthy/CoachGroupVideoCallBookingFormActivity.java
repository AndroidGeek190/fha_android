...
public class CoachGroupVideoCallBookingFormActivity extends ActionBarActivity {
    Button cntinue;
    LinearLayout ll_back;
    RelativeLayout relativeLayDate, relativeLayTime;
    TextView slctDt, txt_gmt,txt_usrNm, txt_desc,availtime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefsHelper=new PrefsHelper(CoachGroupVideoCallBookingFormActivity.this);
       ...
       globalPrefrences=new GlobalPrefrences(this);
        ...
        avail_list= (List<BookingModel>) getIntent().getSerializableExtra("g_list");
        topic_id_list=new ArrayList<>();
        topic_id_list= (List<String>) getIntent().getSerializableExtra("t3_list");
        ...
        time.add("50 Minutes");
        time.add("60 Minutes");
        ArrayAdapter arrayAdapter=new ArrayAdapter<String>(CoachGroupVideoCallBookingFormActivity.this,R.layout.layout_dropdown, time);
        length_time.setAdapter(arrayAdapter);
        ArrayAdapter adapter=new ArrayAdapter<String>(CoachGroupVideoCallBookingFormActivity.this,R.layout.layout_dropdown, topic_id_list);
        ...
        final CaldroidListener listener = new CaldroidListener() {
            ...
            public void onSelectDate(Date date, View view) {
                ...
                if (selectedDate.compareTo(crntDate) > 0 || selectedDate.compareTo(crntDate) <= 0) {
                    ...
                    for (int i = 0; i < selected_avail_list.size(); i++) {
                        ...
                        try {
                            ...
                            if (dt.compareTo(selectedDate)==0) {
                                ...
                                Toast.makeText(CoachGroupVideoCallBookingFormActivity.this, "Coach Not Available", Toast.LENGTH_SHORT);
                                count++;
                                continue;
                    ...
                    Toast.makeText(CoachGroupVideoCallBookingFormActivity.this, "Coach Not Available", Toast.LENGTH_SHORT).show();
                }*/
               }
            @Override
    ...
    private void dialog_time_picker() {
        ...
        availtime=(TextView)dialog.findViewById(R.id.time_text);
        String time = "";
        ...
        ArrayAdapter<String> dataAdapter2 = new ArrayAdapter<String>(CoachGroupVideoCallBookingFormActivity.this,
        ...
        list1.add("11");
        list1.add("12");
        ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<String>(CoachGroupVideoCallBookingFormActivity.this,
        ...
        list.add("AM");
        list.add("PM");
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(CoachGroupVideoCallBookingFormActivity.this,
    ...
    {
        try {
            final ProgressDialog pDialog = new ProgressDialog(CoachGroupVideoCallBookingFormActivity.this);
            ...
            StringRequest sr = new StringRequest(Request.Method.POST,MapAppConstants.API+"/book", new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        Toast.makeText(CoachGroupVideoCallBookingFormActivity.this, "" + serverMessage, Toast.LENGTH_SHORT).show();
                        ...
                        if (serverCode.equalsIgnoreCase("1")) {
                            ...
                            BuyTokenActivity.txt_redm_tokn.setText(prefsHelper.getTokenFromPreference());
                            Intent intent=new Intent(CoachGroupVideoCallBookingFormActivity.this, CoachListActivity.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                        Toast.makeText(CoachGroupVideoCallBookingFormActivity.this, "Timeout Error",
